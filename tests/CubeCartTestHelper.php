...
class CubeCartTestHelper {
	...
	/**
	 * CubeCartTestHelper constructor.
	 *
	 * @param \CubeCart\CubeCartTest\CubeCart\CubecartFullTest $cubecart_test
	 */
	public function __construct( $cubecart_test ) {
		$this->main_test    = $cubecart_test;
		$this->wd           = $cubecart_test->wd;
